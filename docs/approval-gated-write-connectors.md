...
RuleOak Core v1.4 adds a conservative pattern for write connectors.
...
v1.4 write connectors are local dry-run connectors. They do not change external systems.
