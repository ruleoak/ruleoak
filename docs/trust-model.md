...
RuleOak Core includes an local-first governance runtime and sandbox foundation. It is suitable for learning, prototyping, and building controlled workflows. It is not yet a mature enterprise platform, certified compliance product, or externally security-reviewed sandbox.
