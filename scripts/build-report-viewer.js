...
for (const path of reportPaths) {
  const name = path.includes("connector-reliability-demo") ? "connector-reliability-report.html" : path.includes("policy-lab") && path.includes("policy-test") ? "policy-lab-test-report.html" : path.includes("policy-lab") && path.includes("policy-explain") ? "policy-lab-explain-report.html" : path.includes("policy-lab") && path.includes("policy-diff") ? "policy-lab-diff-report.html" : path.includes("policy-packs-demo") ? "policy-packs-report.html" : path.includes("write-connectors-demo") ? "write-connectors-report.html" : path.includes("evidence-connectors-demo") ? "evidence-connectors-report.html" : path.includes("mcp-guard-demo") ? "mcp-guard-report.html" : path.includes("tool-guard-demo") && path.includes("mcp") ? "mcp-guard-tool-demo-report.html" : path.includes("tool-guard-demo") ? "tool-guard-report.html" : path.includes("research-brief-demo") ? "research-brief-report.html" : "technical-consultant-report.html";
